...
(function (global) {
    ...
    // les 2 derniers paramètres sont des callback a exécuter en
    //cas de confirmation pour le deuxième, ou d'infirmation pour le dernier
    ...
    //créer un tableau à deux dimension, chaque élément du tableau
    //est définie à la valeur (optionelle) "value" (vaut 0 par défaut)
    ...
    // retourne la position (démarre à 1) du noeud passé
    //en paramètre dans son parent
        eq: function (node) {
    ...
    // permet de faire afficher un message dans une "boite"
    //spécifique (le noeud qui a la classe game-info)
        info: function (msg) {
